# ExpenseFlow Backend – API Server

This is the backend API for ExpenseFlow, a comprehensive personal finance management system built with Node.js, Express, and MongoDB. It provides secure authentication, income/expense tracking, analytics dashboards, profile image uploads, and Excel export functionality.
